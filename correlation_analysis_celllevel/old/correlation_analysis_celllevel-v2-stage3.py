...
def create_parser():
    ...
    parser.add_argument('-k', '--knn_across', required=True, type=int)
...
if __name__ == '__main__':
    ...
    name = "corr_analysis_smarter_cells_snmcseq_gene_ka{}_k{}_{}_{}".format(ka, k, result_date, today) 
    logging.info(name)

    input_knn_xy = '/cndd2/fangming/projects/miniatlas/results/knn_across_mop_2mods_{}_ka{}_k{}_smarter_cells_snmcseq_gene.npz'.format(result_date, ka, k)
    input_knn_xx = '/cndd2/fangming/projects/miniatlas/results/knn_within_mop_2mods_{}_ka{}_k{}_smarter_cells.npz'.format(result_date, ka, k) 
    ...
    output_to_correlate = '/cndd2/fangming/projects/scf_enhancers/results/{}_corrs_idx.pkl'.format(name)
    ...
    logging.info("{}_{}".format(knn_xy.shape, knn_xx.shape))
