...
if __name__ == '__main__':
    ...
    name = "corr_analysis_smarter_cells_snmcseq_gene_ka{}_knn{}_{}_{}".format(ka, knn, result_date, today) 
    logging.info(name)

    input_knn_xy = '/cndd2/fangming/projects/miniatlas/results/knn_across_mop_2mods_{}_ka{}_knn{}_smarter_cells_snmcseq_gene.npz.{}.npz'.format(result_date, ka, knn, i_sub)
    input_knn_xx = '/cndd2/fangming/projects/miniatlas/results/knn_within_mop_2mods_{}_ka{}_knn{}_smarter_cells.npz.{}.npz'.format(result_date, ka, knn, i_sub) 
    input_knn_cells_xaxis = '/cndd2/fangming/projects/miniatlas/results/cells_{}_mop_2mods_{}_ka{}_knn{}.npy.{}.npy'.format('smarter_cells', result_date, ka, knn, i_sub)
    input_knn_cells_yaxis = '/cndd2/fangming/projects/miniatlas/results/cells_{}_mop_2mods_{}_ka{}_knn{}.npy.{}.npy'.format('snmcseq_gene', result_date, ka, knn, i_sub)
